    ...
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Personalize o comportamento do agente de IA para seu restaurante
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure como a IA deve interagir com seus clientes
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure o nível de sugestões e upselling
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
